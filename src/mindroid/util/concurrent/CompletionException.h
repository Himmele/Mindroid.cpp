...
#ifndef MINDROID_UTIL_CONCURRENT_COMPLETIONEXCEPTION_H_
#define MINDROID_UTIL_CONCURRENT_COMPLETIONEXCEPTION_H_
...
#endif /* MINDROID_UTIL_CONCURRENT_COMPLETIONEXCEPTION_H_ */

...
#ifndef MINDROID_UTIL_CONCURRENT_CANCELLATIONEXCEPTION_H_
#define MINDROID_UTIL_CONCURRENT_CANCELLATIONEXCEPTION_H_
...
#endif /* MINDROID_UTIL_CONCURRENT_CANCELLATIONEXCEPTION_H_ */

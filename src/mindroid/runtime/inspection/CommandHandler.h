...
#ifndef MINDROID_RUNTIME_INSPECTION_COMMANDHANDLER_H_
#define MINDROID_RUNTIME_INSPECTION_COMMANDHANDLER_H_
...
#endif /* MINDROID_RUNTIME_INSPECTION_COMMANDHANDLER_H_ */
